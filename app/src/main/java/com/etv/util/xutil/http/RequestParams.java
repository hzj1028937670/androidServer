...
import com.etv.util.xutil.http.client.entity.BodyParamsEntity;
import com.etv.util.xutil.http.client.multipart.HttpMultipartMode;
...
import com.etv.util.xutil.http.client.multipart.content.FileBody;
import com.etv.util.xutil.http.client.multipart.content.InputStreamBody;
import com.etv.util.xutil.http.client.multipart.content.StringBody;
import com.etv.util.xutil.task.Priority;
